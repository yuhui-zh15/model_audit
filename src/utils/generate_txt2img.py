...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--prompt_path", default="/pasteur/u/yuhuiz/mars_develop/waterbird_text_data.jsonl", type=str, help="Confounder to examine"
    )
    parser.add_argument(
        "--n_img", default=50, type=int, help="Number of images per prompt"
    )
    parser.add_argument(
        "--output_dir", default="/pasteur/u/yuhuiz/data/GeneratedWaterBird", type=str, help="Confounder to examine"
    )
    parser.add_argument(
        "--diffusion_model", default="CompVis/stable-diffusion-v1-4", type=str, help="Confounder to examine"
    )
    parser.add_argument(
